...
<body>
    ...
    <div style="float:left; width:75%">
        <br><br><br>
        <form action="h_match2nd" method="post">
            <h3>Match Details</h3>
            <br>
            ...
            <option class='form-control' value='ht'>Hit Wicket</option>
                        ...
                        echo "' /></td></tr>";
                        if (isset($_POST["marks" . $itr . 'a2nd']) && is_numeric($_POST["marks" . $itr . 'a2nd'])) {
                            $totalA2nd = $totalA2nd + $_POST["marks" . $itr . 'a2nd'];
                        }
                    ...
                    <tr>
                        <td>Extras</td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='number' min='0' name='extrasA2nd' value='";
                    ...
                    <tr>
                        ...
                        <td><input class='form-control' type='number' min='0' name='total2nd'
                                value='<?php echo $totalA2nd; ?>' /></td>
                        <td>for <?php echo $wicketsA2nd; ?> wickets</td>
                    </tr>
                    <tr>
                        <td></td>
            ...
            <table>
                ...
                <tbody>
                    ...
                    for ($itr2 = 1; $itr2 < 12; $itr2++) {
                        ...
                        if (isset($_POST['b' . $itr2 . 'a2nd'])) {
                            echo $_POST['b' . $itr2 . 'a2nd'];
                        }
                        //echo "'/></td><td>";
                ...
                <option class='form-control' value='b'>Bowled</option>
                        ...
                        if (isset($_POST['bovers' . $itr2 . 'a2nd'])) {
                            echo $_POST['bovers' . $itr2 . 'a2nd'];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='number' min='0' name='bruns" . $itr2 . "a2nd' value='";
                        if (isset($_POST['bruns' . $itr2 . 'a2nd']) && is_numeric($_POST['bruns' . $itr2 . 'a2nd'])) {
                            echo $_POST['bruns' . $itr2 . 'a2nd'];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='number' min='0' name='bextras" . $itr2 . "a2nd' value='";
                        if (isset($_POST['bextras' . $itr2 . 'a2nd']) && is_numeric($_POST['bextras' . $itr2 . 'a2nd'])) {
                            echo $_POST['bextras' . $itr2 . 'a2nd'];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='number' min='0' name='bwickets" . $itr2 . "a2nd' value='";
                        if (isset($_POST['bwickets' . $itr2 . 'a2nd']) && is_numeric($_POST['bwickets' . $itr2 . 'a2nd'])) {
                            echo $_POST['bwickets' . $itr2 . 'a2nd'];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='text' name='becon" . $itr2 . "a2nd' value='";
                        if (isset($_POST['becon' . $itr2 . 'a2nd'])) {
                            echo $_POST['becon' . $itr2 . 'a2nd'];
                        }
                        echo "'/></td></tr>";
                    ...
                    <tr>
                        <td></td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='text' name='opoversA2nd' required value='";
...
if (isset($_POST['opoversA2nd'])) {
    $_SESSION['opoversA2nd'] = $_POST['opoversA2nd'];
} else {
    $_SESSION['opoversA2nd'] = NULL;
}
if (isset($_POST['extrasA2nd'])) {
    $_SESSION['extrasA2nd'] = $_POST['extrasA2nd'];
} else {
...
for ($itr2 = 1; $itr2 < $batsmenA2nd; $itr2++) {
    ...
    if (isset($_POST['howout' . $itr2 . 'a2nd'])) {
        $_SESSION['howout' . $itr2 . 'a2nd'] = $_POST['howout' . $itr2 . 'a2nd'];
    }
    if (isset($_POST['marks' . $itr2 . 'a2nd'])) {
        $_SESSION['marks' . $itr2 . 'a2nd'] = $_POST['marks' . $itr2 . 'a2nd'];
    }
}
for ($itr3 = 1; $itr3 < $bowlersA2nd; $itr3++) {
    ...
    if (isset($_POST['bruns' . $itr3 . 'a2nd'])) {
        $_SESSION['bruns' . $itr3 . 'a2nd'] = $_POST['bruns' . $itr3 . 'a2nd'];
    }
    if (isset($_POST['bovers' . $itr3 . 'a2nd'])) {
        $_SESSION['bovers' . $itr3 . 'a2nd'] = $_POST['bovers' . $itr3 . 'a2nd'];
    }
    if (isset($_POST['bextras' . $itr3 . 'a2nd'])) {
        $_SESSION['bextras' . $itr3 . 'a2nd'] = $_POST['bextras' . $itr3 . 'a2nd'];
    }
    if (isset($_POST['bwickets' . $itr3 . 'a2nd'])) {
        $_SESSION['bwickets' . $itr3 . 'a2nd'] = $_POST['bwickets' . $itr3 . 'a2nd'];
    }
}
