...
<body>
    ...
    <div style="float:left; width:75%">
        <br><br><br>
        <form action="2daymatch" method="post">
            ...
            <option class='form-control' value='ht'>Hit Wicket</option>
                        ...
                        echo "' /></td></tr>";
                        if (isset($_POST["marks" . $itr . '2nd']) && is_numeric($_POST["marks" . $itr . '2nd'])) {
                            $total2nd = $total2nd + $_POST["marks" . $itr . '2nd'];
                        }
                    ...
                    <tr>
                        <td>Extras</td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='number' min='0' name='extras2nd' value='";
                    ...
                    <tr>
                        <td>Total</td>
                        <td></td>
                        <td><input class='form-control' type='number' min='0' name='total2nd'
                                value='<?php echo $total2nd; ?>' /></td>
                        <td>for <?php echo $wickets2nd; ?> wickets</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='text' name='overs2nd' required value='";
            ...
            <table>
                ...
                <tbody>
                    ...
                    for ($itr2 = 1; $itr2 < 12; $itr2++) {
                        ...
                        if (isset($_POST['b' . $itr2 . '2nd'])) {
                            echo $_POST['b' . $itr2 . '2nd'];
                        }
                        //echo "'/></td><td>";
                ...
                <option class='form-control' value='b'>Bowled</option>
                        ...
                        if (isset($_POST['bovers' . $itr2 . '2nd'])) {
                            echo $_POST['bovers' . $itr2 . '2nd'];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='number' min='0' name='bruns" . $itr2 . "2nd' value='";
                        if (isset($_POST['bruns' . $itr2 . '2nd']) && is_numeric($_POST['bruns' . $itr2 . '2nd'])) {
                            echo $_POST['bruns' . $itr2 . '2nd'];
                        }
                        echo "'/></td>";
                        if (isset($_POST["bruns" . $itr2 . '2nd']) && is_numeric($_POST['bruns' . $itr2 . '2nd'])) {
                            $optotal2nd = $optotal2nd + $_POST["bruns" . $itr2 . '2nd'];
                        }

                        echo "<td><input class='form-control' type='number' min='0' name='bextras" . $itr2 . "2nd' value='";
                        if (isset($_POST['bextras' . $itr2 . '2nd']) && is_numeric($_POST['bextras' . $itr2 . '2nd'])) {
                            echo $_POST['bextras' . $itr2 . '2nd'];
                        }
                        echo "'/></td>";
                        if (isset($_POST["bextras" . $itr2 . '2nd']) && is_numeric($_POST['bextras' . $itr2 . '2nd'])) {
                            $opextras2nd = $opextras2nd + $_POST["bextras" . $itr2 . '2nd'];
                        }

                        echo "<td><input class='form-control' type='number' min='0' name='bwickets" . $itr2 . "2nd' value='";
                        if (isset($_POST['bwickets' . $itr2 . '2nd']) && is_numeric($_POST['bwickets' . $itr2 . '2nd'])) {
                            echo $_POST['bwickets' . $itr2 . '2nd'];
                        }
                        echo "'/></td>";
                        if (isset($_POST["bwickets" . $itr2 . '2nd']) && is_numeric($_POST['bwickets' . $itr2 . '2nd'])) {
                            $opwickets2nd = $opwickets2nd + $_POST["bwickets" . $itr2 . '2nd'];
                        }

                        echo "<td><input class='form-control' type='text' name='becon" . $itr2 . "2nd' value='";
                        if (isset($_POST['becon' . $itr2 . '2nd'])) {
                            echo $_POST['becon' . $itr2 . '2nd'];
                        }
                        echo "'/></td></tr>";
                    ...
                    <tr>
                        <td>Other Wickets</td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='number' min='0' name='opwickets2nd' value='";
                    ...
                    <tr>
                        <td>Other Extras</td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='number' min='0' name='opoextras2nd' value='";
                    ...
                    <tr>
                        <td>Extras</td>
                        <td></td>
                        <td><input class='form-control' type='number' min='0' name='opextras2nd'
                                value='<?php echo $opextras2nd; ?>' /></td>
                    </tr>
                    <tr>
                        <td>Total</td>
                        <td></td>
                        <td><input class='form-control' type='number' min='0' name='optotal2nd'
                                value='<?php echo $optotal2nd; ?>' /></td>
                        <td>for <?php echo $opwickets2nd; ?> wickets</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='text' name='opovers2nd' required value='";
...
if (isset($_POST['overs2nd'])) {
    $_SESSION['overs2nd'] = $_POST['overs2nd'];
} else {
    $_SESSION['overs2nd'] = NULL;
}
if (isset($_POST['opovers2nd'])) {
    $_SESSION['opovers2nd'] = $_POST['opovers2nd'];
} else {
    $_SESSION['opovers2nd'] = NULL;
}
if (isset($_POST['extras2nd'])) {
    $_SESSION['extras2nd'] = $_POST['extras2nd'];
} else {
...
for ($itr2 = 1; $itr2 < $batsmen2nd; $itr2++) {
    ...
    if (isset($_POST['howout' . $itr2 . '2nd'])) {
        $_SESSION['howout' . $itr2 . '2nd'] = $_POST['howout' . $itr2 . '2nd'];
    }
    if (isset($_POST['marks' . $itr2 . '2nd'])) {
        $_SESSION['marks' . $itr2 . '2nd'] = $_POST['marks' . $itr2 . '2nd'];
    }
}
for ($itr3 = 1; $itr3 < $bowlers2nd; $itr3++) {
    ...
    if (isset($_POST['bruns' . $itr3 . '2nd'])) {
        $_SESSION['bruns' . $itr3 . '2nd'] = $_POST['bruns' . $itr3 . '2nd'];
    }
    if (isset($_POST['bovers' . $itr3 . '2nd'])) {
        $_SESSION['bovers' . $itr3 . '2nd'] = $_POST['bovers' . $itr3 . '2nd'];
    }
    if (isset($_POST['bextras' . $itr3 . '2nd'])) {
        $_SESSION['bextras' . $itr3 . '2nd'] = $_POST['bextras' . $itr3 . '2nd'];
    }
    if (isset($_POST['bwickets' . $itr3 . '2nd'])) {
        $_SESSION['bwickets' . $itr3 . '2nd'] = $_POST['bwickets' . $itr3 . '2nd'];
    }
}
