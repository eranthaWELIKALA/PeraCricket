			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span
								class="glyphicon glyphicon-tasks"></span> Options<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="/"><span class="glyphicon glyphicon-home"></span> Home</a></li>
							<li><a href="view"><span class="glyphicon glyphicon-plus"></span> View Match Details</a>
							</li>
							<li><a href="player"><span class="glyphicon glyphicon-user"></span> View Player Details</a>
							</li>
							<li><a href="rankings"><span class="glyphicon glyphicon-star"></span> View Rankings</a></li>
							<li><a href="records"><span class="glyphicon glyphicon-star-empty"></span> View Records</a>
							</li>
						</ul>
					</li>
				</ul>
...
echo "<br><div class='row' >
            <br>
            <div class='col-md-4' align='center' ><label>";
echo $_SESSION['date'];
echo "</label></div><div class='col-md-4' align='center' ><label>";
echo $_SESSION['format'];
echo "</label></div>
            <div class='col-md-4' align='center' ><label>Match No. : ";
echo $_SESSION['match_no'];
echo "</label></div>
        </div>";
...
<div class='container'>
    ...
    <br><div class='col-md-12' align='center' ><h3>Team A Batting Statistics</h3></div>
		...
		for ($itr = 1; $itr < $_SESSION["batsmenA"]; $itr++) {
			if ($_SESSION['howout' . $itr . 'a'] == 'dnb') {
				$_SESSION['howout' . $itr . 'a'] = "Did Not Bat";
			} else if ($_SESSION['howout' . $itr . 'a'] == 'no') {
				$_SESSION['howout' . $itr . 'a'] = "Not Out";
			} else if ($_SESSION['howout' . $itr . 'a'] == 'b') {
				$_SESSION['howout' . $itr . 'a'] = "Bowled";
			} else if ($_SESSION['howout' . $itr . 'a'] == 'l') {
				$_SESSION['howout' . $itr . 'a'] = "LBW";
			} else if ($_SESSION['howout' . $itr . 'a'] == 'c') {
				$_SESSION['howout' . $itr . 'a'] = "Caught";
			} else if ($_SESSION['howout' . $itr . 'a'] == 'ro') {
				$_SESSION['howout' . $itr . 'a'] = "Run Out";
			} else if ($_SESSION['howout' . $itr . 'a'] == 's') {
				$_SESSION['howout' . $itr . 'a'] = "Stumped";
			} else if ($_SESSION['howout' . $itr . 'a'] == 'ht') {
				$_SESSION['howout' . $itr . 'a'] = "Hit Wicket";
			}
			echo "<br>
            <div class='row' >
    ...
    <br><div class='col-md-12' align='center' ><h3>Team B Batting Statistics</h3></div>
		...
		for ($itr = 1; $itr < $_SESSION["batsmenB"]; $itr++) {
			if ($_SESSION['howout' . $itr . 'b'] == 'dnb') {
				$_SESSION['howout' . $itr . 'b'] = "Did Not Bat";
			} else if ($_SESSION['howout' . $itr . 'b'] == 'no') {
				$_SESSION['howout' . $itr . 'b'] = "Not Out";
			} else if ($_SESSION['howout' . $itr . 'b'] == 'b') {
				$_SESSION['howout' . $itr . 'b'] = "Bowled";
			} else if ($_SESSION['howout' . $itr . 'b'] == 'l') {
				$_SESSION['howout' . $itr . 'b'] = "LBW";
			} else if ($_SESSION['howout' . $itr . 'b'] == 'c') {
				$_SESSION['howout' . $itr . 'b'] = "Caught";
			} else if ($_SESSION['howout' . $itr . 'b'] == 'ro') {
				$_SESSION['howout' . $itr . 'b'] = "Run Out";
			} else if ($_SESSION['howout' . $itr . 'b'] == 's') {
				$_SESSION['howout' . $itr . 'b'] = "Stumped";
			} else if ($_SESSION['howout' . $itr . 'b'] == 'ht') {
				$_SESSION['howout' . $itr . 'b'] = "Hit Wicket";
			}
			echo "<br>
            <div class='row' >
                <div class='col-md-2'></div>
...
<div class='container'>
    ...
    <br><div class='col-md-12' align='center' ><h3>Team A 2nd Innings Batting Statistics</h3></div>
		...
		for ($itr = 1; $itr < $_SESSION["batsmenA2nd"]; $itr++) {
			if ($_SESSION['howout' . $itr . 'a2nd'] == 'dnb') {
				$_SESSION['howout' . $itr . 'a2nd'] = "Did Not Bat";
			} else if ($_SESSION['howout' . $itr . 'a2nd'] == 'no') {
				$_SESSION['howout' . $itr . 'a2nd'] = "Not Out";
			} else if ($_SESSION['howout' . $itr . 'a2nd'] == 'b') {
				$_SESSION['howout' . $itr . 'a2nd'] = "Bowled";
			} else if ($_SESSION['howout' . $itr . 'a2nd'] == 'l') {
				$_SESSION['howout' . $itr . 'a2nd'] = "LBW";
			} else if ($_SESSION['howout' . $itr . 'a2nd'] == 'c') {
				$_SESSION['howout' . $itr . 'a2nd'] = "Caught";
			} else if ($_SESSION['howout' . $itr . 'a2nd'] == 'ro') {
				$_SESSION['howout' . $itr . 'a2nd'] = "Run Out";
			} else if ($_SESSION['howout' . $itr . 'a2nd'] == 's') {
				$_SESSION['howout' . $itr . 'a2nd'] = "Stumped";
			} else if ($_SESSION['howout' . $itr . 'a2nd'] == 'ht') {
				$_SESSION['howout' . $itr . 'a2nd'] = "Hit Wicket";
			}
			echo "<br>
            <div class='row' >
                <div class='col-md-2'></div>
    ...
    <br><div class='col-md-12' align='center' ><h3>Team B 2nd Innings Batting Statistics</h3></div>
		...
		for ($itr = 1; $itr < $_SESSION["batsmenB2nd"]; $itr++) {
			if ($_SESSION['howout' . $itr . 'b2nd'] == 'dnb') {
				$_SESSION['howout' . $itr . 'b2nd'] = "Did Not Bat";
			} else if ($_SESSION['howout' . $itr . 'b2nd'] == 'no') {
				$_SESSION['howout' . $itr . 'b2nd'] = "Not Out";
			} else if ($_SESSION['howout' . $itr . 'b2nd'] == 'b') {
				$_SESSION['howout' . $itr . 'b2nd'] = "Bowled";
			} else if ($_SESSION['howout' . $itr . 'b2nd'] == 'l') {
				$_SESSION['howout' . $itr . 'b2nd'] = "LBW";
			} else if ($_SESSION['howout' . $itr . 'b2nd'] == 'c') {
				$_SESSION['howout' . $itr . 'b2nd'] = "Caught";
			} else if ($_SESSION['howout' . $itr . 'b2nd'] == 'ro') {
				$_SESSION['howout' . $itr . 'b2nd'] = "Run Out";
			} else if ($_SESSION['howout' . $itr . 'b2nd'] == 's') {
				$_SESSION['howout' . $itr . 'b2nd'] = "Stumped";
			} else if ($_SESSION['howout' . $itr . 'b2nd'] == 'ht') {
				$_SESSION['howout' . $itr . 'b2nd'] = "Hit Wicket";
			}
			echo "<br>
            <div class='row' >
                <div class='col-md-2'></div>
...
if (isset($_POST["update"])) {
	for ($itr3 = 1; $itr3 < 12; $itr3++) {
		if (!isset($_SESSION['name' . $itr3 . 'a'])) {
			$_SESSION['name' . $itr3 . 'a'] = NULL;
		}
		if (!isset($_SESSION['howout' . $itr3 . 'a'])) {
			$_SESSION['howout' . $itr3 . 'a'] = NULL;
		}
		if (!isset($_SESSION['marks' . $itr3 . 'a'])) {
			$_SESSION['marks' . $itr3 . 'a'] = NULL;
		}
	}
	for ($itr3 = 1; $itr3 < 12; $itr3++) {
		if (!isset($_SESSION['name' . $itr3 . 'b'])) {
			$_SESSION['name' . $itr3 . 'b'] = NULL;
		}
		if (!isset($_SESSION['howout' . $itr3 . 'b'])) {
			$_SESSION['howout' . $itr3 . 'b'] = NULL;
		}
		if (!isset($_SESSION['marks' . $itr3 . 'b'])) {
			$_SESSION['marks' . $itr3 . 'b'] = NULL;
		}
	}

	for ($itr4 = 1; $itr4 < 12; $itr4++) {
		if (!isset($_SESSION['b' . $itr4 . 'a'])) {
			$_SESSION['b' . $itr4 . 'a'] = NULL;
		}
		if (!isset($_SESSION['bruns' . $itr4 . 'a'])) {
			$_SESSION['bruns' . $itr4 . 'a'] = NULL;
		}
		if (!isset($_SESSION['bovers' . $itr4 . 'a'])) {
			$_SESSION['bovers' . $itr4 . 'a'] = NULL;
		}
		if (!isset($_SESSION['bextras' . $itr4 . 'a'])) {
			$_SESSION['bextras' . $itr4 . 'a'] = NULL;
		}
		if (!isset($_SESSION['bwickets' . $itr4 . 'a'])) {
			$_SESSION['bwickets' . $itr4 . 'a'] = NULL;
		}
	}
	for ($itr4 = 1; $itr4 < 12; $itr4++) {
		if (!isset($_SESSION['b' . $itr4 . 'b'])) {
			$_SESSION['b' . $itr4 . 'b'] = NULL;
		}
		if (!isset($_SESSION['bruns' . $itr4 . 'b'])) {
			$_SESSION['bruns' . $itr4 . 'b'] = NULL;
		}
		if (!isset($_SESSION['bovers' . $itr4 . 'b'])) {
			$_SESSION['bovers' . $itr4 . 'b'] = NULL;
		}
		if (!isset($_SESSION['bextras' . $itr4 . 'b'])) {
			$_SESSION['bextras' . $itr4 . 'b'] = NULL;
		}
		if (!isset($_SESSION['bwickets' . $itr4 . 'b'])) {
			$_SESSION['bwickets' . $itr4 . 'b'] = NULL;
		}
	}
	...
	for ($itr3 = 1; $itr3 < 12; $itr3++) {
		if (!isset($_SESSION['name' . $itr3 . 'a2nd'])) {
			$_SESSION['name' . $itr3 . 'a2nd'] = NULL;
		}
		if (!isset($_SESSION['howout' . $itr3 . 'a2nd'])) {
			$_SESSION['howout' . $itr3 . 'a2nd'] = NULL;
		}
		if (!isset($_SESSION['marks' . $itr3 . 'a2nd'])) {
			$_SESSION['marks' . $itr3 . 'a2nd'] = NULL;
		}
	}
	for ($itr3 = 1; $itr3 < 12; $itr3++) {
		if (!isset($_SESSION['name' . $itr3 . 'b2nd'])) {
			$_SESSION['name' . $itr3 . 'b2nd'] = NULL;
		}
		if (!isset($_SESSION['howout' . $itr3 . 'b2nd'])) {
			$_SESSION['howout' . $itr3 . 'b2nd'] = NULL;
		}
		if (!isset($_SESSION['marks' . $itr3 . 'b2nd'])) {
			$_SESSION['marks' . $itr3 . 'b2nd'] = NULL;
		}
	}

	for ($itr4 = 1; $itr4 < 12; $itr4++) {
		if (!isset($_SESSION['b2nd' . $itr4 . 'a2nd'])) {
			$_SESSION['b2nd' . $itr4 . 'a2nd'] = NULL;
		}
		if (!isset($_SESSION['bruns' . $itr4 . 'a2nd'])) {
			$_SESSION['bruns' . $itr4 . 'a2nd'] = NULL;
		}
		if (!isset($_SESSION['bovers' . $itr4 . 'a2nd'])) {
			$_SESSION['bovers' . $itr4 . 'a2nd'] = NULL;
		}
		if (!isset($_SESSION['bextras' . $itr4 . 'a2nd'])) {
			$_SESSION['bextras' . $itr4 . 'a2nd'] = NULL;
		}
		if (!isset($_SESSION['bwickets' . $itr4 . 'a2nd'])) {
			$_SESSION['bwickets' . $itr4 . 'a2nd'] = NULL;
		}
	}
	for ($itr4 = 1; $itr4 < 12; $itr4++) {
		if (!isset($_SESSION['b2nd' . $itr4 . 'b2nd'])) {
			$_SESSION['b2nd' . $itr4 . 'b2nd'] = NULL;
		}
		if (!isset($_SESSION['bruns' . $itr4 . 'b2nd'])) {
			$_SESSION['bruns' . $itr4 . 'b2nd'] = NULL;
		}
		if (!isset($_SESSION['bovers' . $itr4 . 'b2nd'])) {
			$_SESSION['bovers' . $itr4 . 'b2nd'] = NULL;
		}
		if (!isset($_SESSION['bextras' . $itr4 . 'b2nd'])) {
			$_SESSION['bextras' . $itr4 . 'b2nd'] = NULL;
		}
		if (!isset($_SESSION['bwickets' . $itr4 . 'b2nd'])) {
			$_SESSION['bwickets' . $itr4 . 'b2nd'] = NULL;
		}
	}


	if (!isset($_SESSION['opoversA'])) {
		$_SESSION['opoversA'] = NULL;
	}
	if (!isset($_SESSION['extrasA'])) {
		$_SESSION['extrasA'] = NULL;
	}
	if (!isset($_SESSION['wicketsA'])) {
		$_SESSION['wicketsA'] = NULL;
	}
	if (!isset($_SESSION['totalA'])) {
		$_SESSION['totalA'] = NULL;
	}

	if (!isset($_SESSION['opoversB'])) {
		$_SESSION['opoversB'] = NULL;
	}
	if (!isset($_SESSION['extrasB'])) {
		$_SESSION['extrasB'] = NULL;
	}
	if (!isset($_SESSION['wicketsB'])) {
		$_SESSION['wicketsB'] = NULL;
	}
	if (!isset($_SESSION['totalB'])) {
		$_SESSION['totalB'] = NULL;
	}
	...
	if (!isset($_SESSION['opoversA2nd'])) {
		$_SESSION['opoversA2nd'] = NULL;
	}
	if (!isset($_SESSION['extrasA2nd'])) {
		$_SESSION['extrasA2nd'] = NULL;
	}
	if (!isset($_SESSION['wicketsA2nd'])) {
		$_SESSION['wicketsA2nd'] = NULL;
	}
	if (!isset($_SESSION['totalA2nd'])) {
		$_SESSION['totalA2nd'] = NULL;
	}

	if (!isset($_SESSION['opoversB2nd'])) {
		$_SESSION['opoversB2nd'] = NULL;
	}
	if (!isset($_SESSION['extrasB2nd'])) {
		$_SESSION['extrasB2nd'] = NULL;
	}
	if (!isset($_SESSION['wicketsB2nd'])) {
		$_SESSION['wicketsB2nd'] = NULL;
	}
	if (!isset($_SESSION['totalB2nd'])) {
		$_SESSION['totalB2nd'] = NULL;
	}
	...
	for ($itr5 = 1; $itr5 < $_SESSION["batsmenB"]; $itr5++) {
		...
		if ($_SESSION['howout' . $itr5 . 'b'] == "Not Out") {
			$notout++;
		} else if ($_SESSION['howout' . $itr5 . 'b'] == "Bowled") {
			$bowled++;
		} else if ($_SESSION['howout' . $itr5 . 'b'] == "Caught") {
			$caught++;
		} else if ($_SESSION['howout' . $itr5 . 'b'] == "LBW") {
			$lbw++;
		} else if ($_SESSION['howout' . $itr5 . 'b'] == "Run Out") {
			$runout++;
		} else if ($_SESSION['howout' . $itr5 . 'b'] == "Stumped") {
			$stumped++;
		} else if ($_SESSION['howout' . $itr5 . 'b'] == "Hit Wicket") {
			$hitwicket++;
		}
		...
		if ($itr5 == 1) {
			$one = $one + $_SESSION['marks' . $itr5 . 'b'];
		} else if ($itr5 == 2) {
			$two = $two + $_SESSION['marks' . $itr5 . 'b'];
		} else if ($itr5 == 3) {
			$three = $three + $_SESSION['marks' . $itr5 . 'b'];
		} else if ($itr5 == 4) {
			$four = $four + $_SESSION['marks' . $itr5 . 'b'];
		} else if ($itr5 == 5) {
			$five = $five + $_SESSION['marks' . $itr5 . 'b'];
		} else if ($itr5 == 6) {
			$six = $six + $_SESSION['marks' . $itr5 . 'b'];
		} else if ($itr5 == 7) {
			$seven = $seven + $_SESSION['marks' . $itr5 . 'b'];
		} else if ($itr5 == 8) {
			$eight = $eight + $_SESSION['marks' . $itr5 . 'b'];
		} else if ($itr5 == 9) {
			$nine = $nine + $_SESSION['marks' . $itr5 . 'b'];
		} else if ($itr5 == 10) {
			$ten = $ten + $_SESSION['marks' . $itr5 . 'b'];
		} else if ($itr5 == 11) {
			$eleven = $eleven + $_SESSION['marks' . $itr5 . 'b'];
		}
	...
	for ($itr5 = 1; $itr5 < $_SESSION["batsmenA"]; $itr5++) {
		...
		if ($_SESSION['howout' . $itr5 . 'a'] == "Not Out") {
			$notout++;
		} else if ($_SESSION['howout' . $itr5 . 'a'] == "Bowled") {
			$bowled++;
		} else if ($_SESSION['howout' . $itr5 . 'a'] == "Caught") {
			$caught++;
		} else if ($_SESSION['howout' . $itr5 . 'a'] == "LBW") {
			$lbw++;
		} else if ($_SESSION['howout' . $itr5 . 'a'] == "Run Out") {
			$runout++;
		} else if ($_SESSION['howout' . $itr5 . 'a'] == "Stumped") {
			$stumped++;
		} else if ($_SESSION['howout' . $itr5 . 'a'] == "Hit Wicket") {
			$hitwicket++;
		}
		...
		if ($itr5 == 1) {
			$one = $one + $_SESSION['marks' . $itr5 . 'a'];
		} else if ($itr5 == 2) {
			$two = $two + $_SESSION['marks' . $itr5 . 'a'];
		} else if ($itr5 == 3) {
			$three = $three + $_SESSION['marks' . $itr5 . 'a'];
		} else if ($itr5 == 4) {
			$four = $four + $_SESSION['marks' . $itr5 . 'a'];
		} else if ($itr5 == 5) {
			$five = $five + $_SESSION['marks' . $itr5 . 'a'];
		} else if ($itr5 == 6) {
			$six = $six + $_SESSION['marks' . $itr5 . 'a'];
		} else if ($itr5 == 7) {
			$seven = $seven + $_SESSION['marks' . $itr5 . 'a'];
		} else if ($itr5 == 8) {
			$eight = $eight + $_SESSION['marks' . $itr5 . 'a'];
		} else if ($itr5 == 9) {
			$nine = $nine + $_SESSION['marks' . $itr5 . 'a'];
		} else if ($itr5 == 10) {
			$ten = $ten + $_SESSION['marks' . $itr5 . 'a'];
		} else if ($itr5 == 11) {
			$eleven = $eleven + $_SESSION['marks' . $itr5 . 'a'];
		}
	...
	for ($itr5 = 1; $itr5 < $_SESSION["batsmenB2nd"]; $itr5++) {
		...
		if ($_SESSION['howout' . $itr5 . 'b2nd'] == "Not Out") {
			$notout++;
		} else if ($_SESSION['howout' . $itr5 . 'b2nd'] == "Bowled") {
			$bowled++;
		} else if ($_SESSION['howout' . $itr5 . 'b2nd'] == "Caught") {
			$caught++;
		} else if ($_SESSION['howout' . $itr5 . 'b2nd'] == "LBW") {
			$lbw++;
		} else if ($_SESSION['howout' . $itr5 . 'b2nd'] == "Run Out") {
			$runout++;
		} else if ($_SESSION['howout' . $itr5 . 'b2nd'] == "Stumped") {
			$stumped++;
		} else if ($_SESSION['howout' . $itr5 . 'b2nd'] == "Hit Wicket") {
			$hitwicket++;
		}
		...
		if ($itr5 == 1) {
			$one = $one + $_SESSION['marks' . $itr5 . 'b2nd'];
		} else if ($itr5 == 2) {
			$two = $two + $_SESSION['marks' . $itr5 . 'b2nd'];
		} else if ($itr5 == 3) {
			$three = $three + $_SESSION['marks' . $itr5 . 'b2nd'];
		} else if ($itr5 == 4) {
			$four = $four + $_SESSION['marks' . $itr5 . 'b2nd'];
		} else if ($itr5 == 5) {
			$five = $five + $_SESSION['marks' . $itr5 . 'b2nd'];
		} else if ($itr5 == 6) {
			$six = $six + $_SESSION['marks' . $itr5 . 'b2nd'];
		} else if ($itr5 == 7) {
			$seven = $seven + $_SESSION['marks' . $itr5 . 'b2nd'];
		} else if ($itr5 == 8) {
			$eight = $eight + $_SESSION['marks' . $itr5 . 'b2nd'];
		} else if ($itr5 == 9) {
			$nine = $nine + $_SESSION['marks' . $itr5 . 'b2nd'];
		} else if ($itr5 == 10) {
			$ten = $ten + $_SESSION['marks' . $itr5 . 'b2nd'];
		} else if ($itr5 == 11) {
			$eleven = $eleven + $_SESSION['marks' . $itr5 . 'b2nd'];
		}
	...
	for ($itr5 = 1; $itr5 < $_SESSION["batsmenA2nd"]; $itr5++) {
		...
		if ($_SESSION['howout' . $itr5 . 'a2nd'] == "Not Out") {
			$notout++;
		} else if ($_SESSION['howout' . $itr5 . 'a2nd'] == "Bowled") {
			$bowled++;
		} else if ($_SESSION['howout' . $itr5 . 'a2nd'] == "Caught") {
			$caught++;
		} else if ($_SESSION['howout' . $itr5 . 'a2nd'] == "LBW") {
			$lbw++;
		} else if ($_SESSION['howout' . $itr5 . 'a2nd'] == "Run Out") {
			$runout++;
		} else if ($_SESSION['howout' . $itr5 . 'a2nd'] == "Stumped") {
			$stumped++;
		} else if ($_SESSION['howout' . $itr5 . 'a2nd'] == "Hit Wicket") {
			$hitwicket++;
		}
		...
		if ($itr5 == 1) {
			$one = $one + $_SESSION['marks' . $itr5 . 'a2nd'];
		} else if ($itr5 == 2) {
			$two = $two + $_SESSION['marks' . $itr5 . 'a2nd'];
		} else if ($itr5 == 3) {
			$three = $three + $_SESSION['marks' . $itr5 . 'a2nd'];
		} else if ($itr5 == 4) {
			$four = $four + $_SESSION['marks' . $itr5 . 'a2nd'];
		} else if ($itr5 == 5) {
			$five = $five + $_SESSION['marks' . $itr5 . 'a2nd'];
		} else if ($itr5 == 6) {
			$six = $six + $_SESSION['marks' . $itr5 . 'a2nd'];
		} else if ($itr5 == 7) {
			$seven = $seven + $_SESSION['marks' . $itr5 . 'a2nd'];
		} else if ($itr5 == 8) {
			$eight = $eight + $_SESSION['marks' . $itr5 . 'a2nd'];
		} else if ($itr5 == 9) {
			$nine = $nine + $_SESSION['marks' . $itr5 . 'a2nd'];
		} else if ($itr5 == 10) {
			$ten = $ten + $_SESSION['marks' . $itr5 . 'a2nd'];
		} else if ($itr5 == 11) {
			$eleven = $eleven + $_SESSION['marks' . $itr5 . 'a2nd'];
		}
