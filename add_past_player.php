...
require "connect.php";
function count_queries($connect, $attribute)
{
...
if (isset($_POST['add'])) {
    ...
    $player_reg_no = "oba" . count_queries($connect, $count_query);
    $zero = 0;
        ...
        echo '<br><br><br><div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="addplayer" class="close" data-dismiss="alert" arial-label="close">&times</a>
...
<body>
    ...
    <div class='container' align='center'>
        <h3>Add a New Past Player</h3>
    </div>
    <br><br>
    <div class='container' align='center'>
        <form enctype="multipart/form-data" action="add_past_player" method="post">
            <table>
                <tr>
                    <td>Firstname</td>
                    <td><input class="form-control" type="text" name="player_fname" required></td>
                </tr>
                <tr>
                    <td>Lastname</td>
                    <td> <input class="form-control" type="text" name="player_lname" required></td>
                </tr>
            </table>
