...
for ($itr = 1; $itr < $_SESSION["batsmen"]; $itr++) {
	if ($_SESSION['howout' . $itr] == 'dnb') {
		$_SESSION['howout' . $itr] = "Did Not Bat";
	} else if ($_SESSION['howout' . $itr] == 'no') {
		$_SESSION['howout' . $itr] = "Not Out";
	} else if ($_SESSION['howout' . $itr] == 'b') {
		$_SESSION['howout' . $itr] = "Bowled";
	} else if ($_SESSION['howout' . $itr] == 'l') {
		$_SESSION['howout' . $itr] = "LBW";
	} else if ($_SESSION['howout' . $itr] == 'c') {
		$_SESSION['howout' . $itr] = "Caught";
	} else if ($_SESSION['howout' . $itr] == 'ro') {
		$_SESSION['howout' . $itr] = "Run Out";
	} else if ($_SESSION['howout' . $itr] == 's') {
		$_SESSION['howout' . $itr] = "Stumped";
	} else if ($_SESSION['howout' . $itr] == 'ht') {
		$_SESSION['howout' . $itr] = "Hit Wicket";
	}
	echo "<br>
            <div class='row' >
...
for ($itr = 1; $itr < $_SESSION["batsmen2nd"]; $itr++) {
	if ($_SESSION['howout' . $itr . '2nd'] == 'dnb') {
		$_SESSION['howout' . $itr . '2nd'] = "Did Not Bat";
	} else if ($_SESSION['howout' . $itr . '2nd'] == 'no') {
		$_SESSION['howout' . $itr . '2nd'] = "Not Out";
	} else if ($_SESSION['howout' . $itr . '2nd'] == 'b') {
		$_SESSION['howout' . $itr . '2nd'] = "Bowled";
	} else if ($_SESSION['howout' . $itr . '2nd'] == 'l') {
		$_SESSION['howout' . $itr . '2nd'] = "LBW";
	} else if ($_SESSION['howout' . $itr . '2nd'] == 'c') {
		$_SESSION['howout' . $itr . '2nd'] = "Caught";
	} else if ($_SESSION['howout' . $itr . '2nd'] == 'ro') {
		$_SESSION['howout' . $itr . '2nd'] = "Run Out";
	} else if ($_SESSION['howout' . $itr . '2nd'] == 's') {
		$_SESSION['howout' . $itr . '2nd'] = "Stumped";
	} else if ($_SESSION['howout' . $itr . '2nd'] == 'ht') {
		$_SESSION['howout' . $itr . '2nd'] = "Hit Wicket";
	}
	echo "<br>
            <div class='row' >
                <div class='col-md-2'></div>
...
if (isset($_POST["update"])) {
	...
	for ($itr3 = 1; $itr3 < 12; $itr3++) {
		if (!isset($_SESSION['name' . $itr3])) {
			$_SESSION['name' . $itr3] = NULL;
		}
		if (!isset($_SESSION['howout' . $itr3])) {
			$_SESSION['howout' . $itr3] = NULL;
		}
		if (!isset($_SESSION['marks' . $itr3])) {
			$_SESSION['marks' . $itr3] = NULL;
		}
	}
	for ($itr4 = 1; $itr4 < 12; $itr4++) {
		if (!isset($_SESSION['b' . $itr4])) {
			$_SESSION['b' . $itr4] = NULL;
		}
		if (!isset($_SESSION['bruns' . $itr4])) {
			$_SESSION['bruns' . $itr4] = NULL;
		}
		if (!isset($_SESSION['bovers' . $itr4])) {
			$_SESSION['bovers' . $itr4] = NULL;
		}
		if (!isset($_SESSION['bextras' . $itr4])) {
			$_SESSION['bextras' . $itr4] = NULL;
		}
		if (!isset($_SESSION['bwickets' . $itr4])) {
			$_SESSION['bwickets' . $itr4] = NULL;
		}
	}

	for ($itr3 = 1; $itr3 < 12; $itr3++) {
		if (!isset($_SESSION['name' . $itr3 . '2nd'])) {
			$_SESSION['name' . $itr3 . '2nd'] = NULL;
		}
		if (!isset($_SESSION['howout' . $itr3 . '2nd'])) {
			$_SESSION['howout' . $itr3 . '2nd'] = NULL;
		}
		if (!isset($_SESSION['marks' . $itr3 . '2nd'])) {
			$_SESSION['marks' . $itr3 . '2nd'] = NULL;
		}
	}
	for ($itr4 = 1; $itr4 < 12; $itr4++) {
		if (!isset($_SESSION['b' . $itr4 . '2nd'])) {
			$_SESSION['b' . $itr4 . '2nd'] = NULL;
		}
		if (!isset($_SESSION['bruns' . $itr4 . '2nd'])) {
			$_SESSION['bruns' . $itr4 . '2nd'] = NULL;
		}
		if (!isset($_SESSION['bovers' . $itr4 . '2nd'])) {
			$_SESSION['bovers' . $itr4 . '2nd'] = NULL;
		}
		if (!isset($_SESSION['bextras' . $itr4 . '2nd'])) {
			$_SESSION['bextras' . $itr4 . '2nd'] = NULL;
		}
		if (!isset($_SESSION['bwickets' . $itr4 . '2nd'])) {
			$_SESSION['bwickets' . $itr4 . '2nd'] = NULL;
		}
	}
	if (!isset($_SESSION['overs'])) {
		$_SESSION['overs'] = NULL;
	}
	if (!isset($_SESSION['opovers'])) {
		$_SESSION['opovers'] = NULL;
	}
	if (!isset($_SESSION['extras'])) {
		$_SESSION['extras'] = NULL;
	}
	if (!isset($_SESSION['opextras'])) {
		$_SESSION['opextras'] = NULL;
	}

	if (!isset($_SESSION['overs2nd'])) {
		$_SESSION['overs2nd'] = NULL;
	}
	if (!isset($_SESSION['opovers2nd'])) {
		$_SESSION['opovers2nd'] = NULL;
	}
	if (!isset($_SESSION['extras2nd'])) {
		$_SESSION['extras2nd'] = NULL;
	}
	if (!isset($_SESSION['opextras2nd'])) {
		$_SESSION['opextras2nd'] = NULL;
	}
		...
		echo '<div class="container">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<a href="result" class="close" data-dismiss="alert" arial-label="close">&times</a>
	...
	for ($itr5 = 1; $itr5 < $_SESSION["batsmen"]; $itr5++) {
		...
		//Updating how out?
		if ($_SESSION['howout' . $itr5] == "Not Out") {
			$notout++;
		} else if ($_SESSION['howout' . $itr5] == "Bowled") {
			$bowled++;
		} else if ($_SESSION['howout' . $itr5] == "Caught") {
			$caught++;
		} else if ($_SESSION['howout' . $itr5] == "LBW") {
			$lbw++;
		} else if ($_SESSION['howout' . $itr5] == "Run Out") {
			$runout++;
		} else if ($_SESSION['howout' . $itr5] == "Stumped") {
			$stumped++;
		} else if ($_SESSION['howout' . $itr5] == "Hit Wicket") {
			$hitwicket++;
		}
		...
		if ($itr5 == 1) {
			$one = $one + $_SESSION['marks' . $itr5];
		} else if ($itr5 == 2) {
			$two = $two + $_SESSION['marks' . $itr5];
		} else if ($itr5 == 3) {
			$three = $three + $_SESSION['marks' . $itr5];
		} else if ($itr5 == 4) {
			$four = $four + $_SESSION['marks' . $itr5];
		} else if ($itr5 == 5) {
			$five = $five + $_SESSION['marks' . $itr5];
		} else if ($itr5 == 6) {
			$six = $six + $_SESSION['marks' . $itr5];
		} else if ($itr5 == 7) {
			$seven = $seven + $_SESSION['marks' . $itr5];
		} else if ($itr5 == 8) {
			$eight = $eight + $_SESSION['marks' . $itr5];
		} else if ($itr5 == 9) {
			$nine = $nine + $_SESSION['marks' . $itr5];
		} else if ($itr5 == 10) {
			$ten = $ten + $_SESSION['marks' . $itr5];
		} else if ($itr5 == 11) {
			$eleven = $eleven + $_SESSION['marks' . $itr5];
		}
	...
	for ($itr5 = 1; $itr5 < $_SESSION["batsmen2nd"]; $itr5++) {
		...
		//Updating how out?
		if ($_SESSION['howout' . $itr5 . '2nd'] == "Not Out") {
			$notout++;
		} else if ($_SESSION['howout' . $itr5 . '2nd'] == "Bowled") {
			$bowled++;
		} else if ($_SESSION['howout' . $itr5 . '2nd'] == "Caught") {
			$caught++;
		} else if ($_SESSION['howout' . $itr5 . '2nd'] == "LBW") {
			$lbw++;
		} else if ($_SESSION['howout' . $itr5 . '2nd'] == "Run Out") {
			$runout++;
		} else if ($_SESSION['howout' . $itr5 . '2nd'] == "Stumped") {
			$stumped++;
		} else if ($_SESSION['howout' . $itr5 . '2nd'] == "Hit Wicket") {
			$hitwicket++;
		}
		...
		//Adding batting place scores
		if ($itr5 == 1) {
			$one = $one + $_SESSION['marks' . $itr5 . '2nd'];
		} else if ($itr5 == 2) {
			$two = $two + $_SESSION['marks' . $itr5 . '2nd'];
		} else if ($itr5 == 3) {
			$three = $three + $_SESSION['marks' . $itr5 . '2nd'];
		} else if ($itr5 == 4) {
			$four = $four + $_SESSION['marks' . $itr5 . '2nd'];
		} else if ($itr5 == 5) {
			$five = $five + $_SESSION['marks' . $itr5 . '2nd'];
		} else if ($itr5 == 6) {
			$six = $six + $_SESSION['marks' . $itr5 . '2nd'];
		} else if ($itr5 == 7) {
			$seven = $seven + $_SESSION['marks' . $itr5 . '2nd'];
		} else if ($itr5 == 8) {
			$eight = $eight + $_SESSION['marks' . $itr5 . '2nd'];
		} else if ($itr5 == 9) {
			$nine = $nine + $_SESSION['marks' . $itr5 . '2nd'];
		} else if ($itr5 == 10) {
			$ten = $ten + $_SESSION['marks' . $itr5 . '2nd'];
		} else if ($itr5 == 11) {
			$eleven = $eleven + $_SESSION['marks' . $itr5 . '2nd'];
		}
