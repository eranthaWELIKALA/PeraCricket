...
<body>
    ...
    <div style="float:left; width:75%">
        <br><br><br>
        <form action="h_b_match" method="post">
            <h3>Match Details</h3>
            ...
            <option class='form-control' value='ht'>Hit Wicket</option>
                        ...
                        echo "' /></td></tr>";
                        if (isset($_POST["marks" . $itr . 'b']) && is_numeric($_POST["marks" . $itr . 'b'])) {
                            $totalB = $totalB + $_POST["marks" . $itr . 'b'];
                        }
                    ...
                    <tr>
                        <td>Extras</td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='number' min='0' name='extrasB' value='";
                    ...
                    <tr>
                        <td>Total</td>
                        <td></td>
                        <td><input class='form-control' type='number' min='0' name='totalB'
                                value='<?php echo $totalB; ?>' /></td>
                        <td>for <?php echo $wicketsB; ?> wickets</td>
                    </tr>
            ...
            <table>
                ...
                <option class='form-control' value='b'>Bowled</option>
                        ...
                        if (isset($_POST['bovers' . $itr2 . 'b'])) {
                            echo $_POST['bovers' . $itr2 . 'b'];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='number' min='0' name='bruns" . $itr2 . "b" . "' value='";
                        if (isset($_POST['bruns' . $itr2 . 'b']) && is_numeric($_POST['bruns' . $itr2 . 'b'])) {
                            echo $_POST['bruns' . $itr2 . 'b'];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='number' min='0' name='bextras" . $itr2 . "b" . "' value='";
                        if (isset($_POST['bextras' . $itr2 . 'b']) && is_numeric($_POST['bextras' . $itr2 . 'b'])) {
                            echo $_POST['bextras' . $itr2 . 'b'];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='number' min='0' name='bwickets" . $itr2 . "b" . "' value='";
                        if (isset($_POST['bwickets' . $itr2 . 'b']) && is_numeric($_POST['bwickets' . $itr2 . 'b'])) {
                            echo $_POST['bwickets' . $itr2 . 'b'];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='text' name='becon" . $itr2 . "b" . "' value='";
                        if (isset($_POST['becon' . $itr2 . 'b'])) {
                            echo $_POST['becon' . $itr2 . 'b'];
                        }
                        echo "'/></td></tr>";
                    ...
                    <tr>
                        <td></td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='text' name='opoversB' required value='";
...
if (isset($_POST['opoversB'])) {
    $_SESSION['opoversB'] = $_POST['opoversB'];
} else {
    $_SESSION['opoversB'] = NULL;
}
if (isset($_POST['extrasB'])) {
    $_SESSION['extrasB'] = $_POST['extrasB'];
} else {
...
for ($itr2 = 1; $itr2 < $batsmenB; $itr2++) {
    ...
    if (isset($_POST['howout' . $itr2 . 'b'])) {
        $_SESSION['howout' . $itr2 . 'b'] = $_POST['howout' . $itr2 . 'b'];
    }
    if (isset($_POST['marks' . $itr2 . 'b'])) {
        $_SESSION['marks' . $itr2 . 'b'] = $_POST['marks' . $itr2 . 'b'];
    }
}
for ($itr3 = 1; $itr3 < $bowlersB; $itr3++) {
    ...
    if (isset($_POST['bruns' . $itr3 . 'b'])) {
        $_SESSION['bruns' . $itr3 . 'b'] = $_POST['bruns' . $itr3 . 'b'];
    }
    if (isset($_POST['bovers' . $itr3 . 'b'])) {
        $_SESSION['bovers' . $itr3 . 'b'] = $_POST['bovers' . $itr3 . 'b'];
    }
    if (isset($_POST['bextras' . $itr3 . 'b'])) {
        $_SESSION['bextras' . $itr3 . 'b'] = $_POST['bextras' . $itr3 . 'b'];
    }
    if (isset($_POST['bwickets' . $itr3 . 'b'])) {
        $_SESSION['bwickets' . $itr3 . 'b'] = $_POST['bwickets' . $itr3 . 'b'];
    }
}
