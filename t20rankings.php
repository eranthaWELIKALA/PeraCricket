    ...
    <div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
            <li>
                <a class="btn btn-info" href="50rankings.php">50-50</a>
            </li>
...
<br/><br/><br/>
    ...
    <div class='container'>
        <div class="panel-body collapse" id="batting">
                  <?php
            $average_query="SELECT * from t20batting_statistics ORDER BY Average DESC LIMIT 10";
            $is_average_query_run=mysqli_query($connect,$average_query);
            $itr=1;
            echo "<br><p align='center'><h4>T20 Batting Rankings</h4>(According to the Batting Average)</p>";
        ...
        <br><br>
        <?php
            $runs_query="SELECT * from t20batting_statistics ORDER BY Runs DESC LIMIT 10";
            $is_runs_query_run=mysqli_query($connect,$runs_query);
            $itr=1;
            echo "<br><p align='center'><h4>T20 Batting Rankings</h4>(According to Runs)</p>";
    ...
    <div class='container'>
        <div class="panel-body collapse" id="bowling">
                    <?php
            $wickets_query="SELECT * from t20bowling_statistics ORDER BY Wickets DESC LIMIT 10";
            $is_wickets_query_run=mysqli_query($connect,$wickets_query);
            $itr=1;
            echo "<br><p align='center'><h4>T20 Bowling Rankings</h4>(According to No. of Wickets)</p>";
        ...
        <br><br>
        <?php
            $econ_query="SELECT * from t20bowling_statistics  WHERE Overs>1 ORDER BY Econ ASC LIMIT 10";
            $is_econ_query_run=mysqli_query($connect,$econ_query);
            $itr=1;
            echo "<br><p align='center'><h4>T20 Bowling Rankings</h4>(According to Economy)</p>";
        ...
        <br><br>
        <?php
            $econ_query="SELECT * from t20bowling_statistics  WHERE Wickets>1 ORDER BY Average ASC LIMIT 10";
            $is_econ_query_run=mysqli_query($connect,$econ_query);
            $itr=1;
            echo "<br><p align='center'><h4>T20 Bowling Rankings</h4>(According to Average)</p>";
            while($econ_query_execute=mysqli_fetch_assoc($is_econ_query_run)){
                $ec_query="SELECT * FROM player_informations WHERE Reg_no='".$econ_query_execute['Reg_no']."'";
                $is_ec_query_run=mysqli_query($connect,$ec_query);
                $ec_query_execute=mysqli_fetch_assoc($is_ec_query_run);
...
<script type="text/javascript">
    ...
    function call(){
        alert("If you want to see 50-50 Rankings Click \"50-50\" Blue Button");
    }
    //call();
