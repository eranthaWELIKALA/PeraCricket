        ...
        <form action="match" method="post">
            ...
            <table>
                <tbody>
                    <tr>
                        <td><b>Date</b></td>
                        <td><input type="date" class="form-control" name="date" required value="<?php if (isset($_POST['date'])) {
                            echo $_POST['date'];
                        } ?>"></td>
                    </tr>
                    <tr>
            ...
            <option class='form-control' value='ht'>Hit Wicket</option>
                        ...
                        echo "' /></td></tr>";
                        if (isset($_POST["marks" . $itr]) && is_numeric($_POST["marks" . $itr])) {
                            $total = $total + $_POST["marks" . $itr];
                        }
                    ...
                    <tr>
                        <td>Extras</td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='number' min='0' name='extras' value='";
                    ...
                    <tr>
                        <td>Total</td>
                        <td></td>
                        <td><input class='form-control' type='number' min='0' name='total'
                                value='<?php echo $total; ?>' /></td>
                        <td>for <?php echo $wickets; ?> wickets</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='text' name='overs' required value='";
            ...
            <table>
                ...
                <option class='form-control' value='b'>Bowled</option>
                        ...
                        if (isset($_POST['bovers' . $itr2])) {
                            echo $_POST['bovers' . $itr2];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='number' min='0' name='bruns" . $itr2 . "' value='";
                        if (isset($_POST['bruns' . $itr2]) && is_numeric($_POST['bruns' . $itr2])) {
                            echo $_POST['bruns' . $itr2];
                        }
                        echo "'/></td>";
                        if (isset($_POST["bruns" . $itr2]) && is_numeric($_POST['bruns' . $itr2])) {
                            $optotal = $optotal + $_POST["bruns" . $itr2];
                        }

                        echo "<td><input class='form-control' type='number' min='0' name='bextras" . $itr2 . "' value='";
                        if (isset($_POST['bextras' . $itr2]) && is_numeric($_POST['bextras' . $itr2])) {
                            echo $_POST['bextras' . $itr2];
                        }
                        echo "'/></td>";
                        if (isset($_POST["bextras" . $itr2]) && is_numeric($_POST['bextras' . $itr2])) {
                            $opextras = $opextras + $_POST["bextras" . $itr2];
                        }

                        echo "<td><input class='form-control' type='number' min='0' name='bwickets" . $itr2 . "' value='";
                        if (isset($_POST['bwickets' . $itr2]) && is_numeric($_POST['bwickets' . $itr2])) {
                            echo $_POST['bwickets' . $itr2];
                        }
                        echo "'/></td>";
                        if (isset($_POST["bwickets" . $itr2]) && is_numeric($_POST['bwickets' . $itr2])) {
                            $opwickets = $opwickets + $_POST["bwickets" . $itr2];
                        }

                        echo "<td><input class='form-control' type='text' name='becon" . $itr2 . "' value='";
                        if (isset($_POST['becon' . $itr2])) {
                            echo $_POST['becon' . $itr2];
                        }
                        echo "'/></td></tr>";
                    ...
                    <tr>
                        <td>Other Wickets</td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='number' min='0' name='opwickets' value='";
                    ...
                    <tr>
                        <td>Other Extras</td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='number' min='0' name='opoextras' value='";
                    ...
                    <tr>
                        <td>Extras</td>
                        <td></td>
                        <td><input class='form-control' type='number' min='0' name='opextras'
                                value='<?php echo $opextras; ?>' /></td>
                    </tr>
                    <tr>
                        <td>Total</td>
                        <td></td>
                        <td><input class='form-control' type='number' min='0' name='optotal'
                                value='<?php echo $optotal; ?>' /></td>
                        <td>for <?php echo $opwickets; ?> wickets</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='text' name='opovers' required value='";
...
if (isset($_POST['opovers'])) {
    $_SESSION['opovers'] = $_POST['opovers'];
} else {
...
for ($itr2 = 1; $itr2 < $batsmen; $itr2++) {
    ...
    if (isset($_POST['howout' . $itr2])) {
        $_SESSION['howout' . $itr2] = $_POST['howout' . $itr2];
    }
    if (isset($_POST['marks' . $itr2])) {
        $_SESSION['marks' . $itr2] = $_POST['marks' . $itr2];
    }
}
for ($itr3 = 1; $itr3 < $bowlers; $itr3++) {
    ...
    if (isset($_POST['bruns' . $itr3])) {
        $_SESSION['bruns' . $itr3] = $_POST['bruns' . $itr3];
    }
    if (isset($_POST['bovers' . $itr3])) {
        $_SESSION['bovers' . $itr3] = $_POST['bovers' . $itr3];
    }
    if (isset($_POST['bextras' . $itr3])) {
        $_SESSION['bextras' . $itr3] = $_POST['bextras' . $itr3];
    }
    if (isset($_POST['bwickets' . $itr3])) {
        $_SESSION['bwickets' . $itr3] = $_POST['bwickets' . $itr3];
    }
}
if (isset($_POST['op'])) {
    if (!empty($_POST['op'])) {
