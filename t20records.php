...
<body>
            ...
            <div>
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        <li>
                            <a class="btn btn-info" href="50records">50-50</a>
                        </li>
        ...
        <div class="row">
            <div class="col-xs-8 col-xs-offset-2">
                <ul class="nav nav-tabs nav-justified">
                    <li><a href="/.phpbatting" data-toggle="tab">T20 Batting</a> </li>
                    <li><a href="/.phpbowling" data-toggle="tab">T20 Bowling</a> </li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <table class="table table-hover table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $caught_query = "SELECT * FROM t20batting_statistics ORDER BY Caught DESC LIMIT 1";
                                        ...
                                        if ($caught_query_execute['Caught'] != 0) {
                                            ...
                                            if ($caught_retrieve_query_execute['Firstname'] != NULL) {
                                                echo $caught_retrieve_query_execute['Firstname'] . " " . $caught_retrieve_query_execute['Lastname'] . "</td><td>" . $caught_query_execute['Caught'];
                                            } else {
                                                $caught_retrieve_query1 = "SELECT * FROM past_player_informations WHERE Reg_no='" . $caught_query_execute['Reg_no'] . "'";
                                                $is_caught_retrieve_query_run1 = mysqli_query($connect, $caught_retrieve_query1);
                                                $caught_retrieve_query_execute1 = mysqli_fetch_assoc($is_caught_retrieve_query_run1);
                                                echo $caught_retrieve_query_execute1['Firstname'] . " " . $caught_retrieve_query_execute1['Lastname'] . "</td><td>" . $caught_query_execute['Caught'];
                                            }
                                        } else {
                                            echo "</td><td>";
                                        } ?>
                                    </td>
                                    <td><a href="#" data-target="#caughtModal" data-toggle="modal"> <span
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $bowled_query = "SELECT * FROM t20batting_statistics ORDER BY Bowled DESC LIMIT 1";
                                    ...
                                    <td><a href="#" data-target="#bowledModal" data-toggle="modal"> <span
                                                class="glyphicon glyphicon-chevron-down"></span> </a></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <?php
                                        $lbw_query = "SELECT * FROM t20batting_statistics ORDER BY LBW DESC LIMIT 1";
                                        ...
                                        if ($lbw_query_execute['LBW'] != 0) {
                                            ...
                                            if ($lbw_retrieve_query_execute['Firstname'] != NULL) {
                                                echo $lbw_retrieve_query_execute['Firstname'] . " " . $lbw_retrieve_query_execute['Lastname'] . "</td><td>" . $lbw_query_execute['LBW'];
                                            } else {
                                                $lbw_retrieve_query1 = "SELECT * FROM past_player_informations WHERE Reg_no='" . $lbw_query_execute['Reg_no'] . "'";
                                                $is_lbw_retrieve_query_run1 = mysqli_query($connect, $lbw_retrieve_query1);
                                                $lbw_retrieve_query_execute1 = mysqli_fetch_assoc($is_lbw_retrieve_query_run1);
                                                echo $lbw_retrieve_query_execute1['Firstname'] . " " . $lbw_retrieve_query_execute1['Lastname'] . "</td><td>" . $lbw_query_execute['LBW'];
                                            }
                                        } else {
                                            echo "</td><td>";
                                        } ?>
                                    </td>
                                    <td><a href="#" data-target="#lbwModal" data-toggle="modal"> <span
                                                class="glyphicon glyphicon-chevron-down"></span> </a></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <?php
                                        $runout_query = "SELECT * FROM t20batting_statistics ORDER BY Runout DESC LIMIT 1";
                                    ...
                                    <td><a href="#" data-target="#runoutModal" data-toggle="modal"> <span
                                                class="glyphicon glyphicon-chevron-down"></span> </a></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <?php
                                        $stumped_query = "SELECT * FROM t20batting_statistics ORDER BY Stumped DESC LIMIT 1";
                                    ...
                                    <td><a href="#" data-target="#stumpedModal" data-toggle="modal"> <span
                                                class="glyphicon glyphicon-chevron-down"></span> </a></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td><?php
                                    $hitwicket_query = "SELECT * FROM t20batting_statistics ORDER BY Hitwicket DESC LIMIT 1";
                                    ...
                                    <td><a href="#" data-target="#hitwicketModal" data-toggle="modal"> <span
                                                class="glyphicon glyphicon-chevron-down"></span> </a></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <?php
                                        $notout_query = "SELECT * FROM t20batting_statistics ORDER BY Notout DESC LIMIT 1";
                                    ...
                                    <td><a href="#" data-target="#notoutModal" data-toggle="modal"> <span
                                                class="glyphicon glyphicon-chevron-down"></span> </a></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td><?php
                                    $hundreds_query = "SELECT * FROM t20batting_statistics ORDER BY Hundreds DESC LIMIT 1";
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                    $fifties_query = "SELECT * FROM t20batting_statistics ORDER BY Fifties DESC LIMIT 1";
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                    $most_query = "SELECT * FROM t20batting_statistics ORDER BY Most DESC LIMIT 1";
                        ...
                        <table class="table table-hover table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php
                                    $five_wickets_query = "SELECT * FROM t20bowling_statistics ORDER BY Five_wickets DESC LIMIT 1";
                                    ...
                                    if ($five_wickets_query_execute['Five_wickets'] != 0) {
                                        ...
                                        if ($five_wickets_retrieve_query_execute['Firstname'] != null) {
                                            ...
                                            $five_wickets_retrieve_query1 = "SELECT * FROM past_player_informations WHERE Reg_no='" . $five_wickets_query_execute['Reg_no'] . "'";
                                            $is_five_wickets_retrieve_query_run1 = mysqli_query($connect, $five_wickets_retrieve_query1);
                                            $five_wickets_retrieve_query_execute1 = mysqli_fetch_assoc($is_five_wickets_retrieve_query_run1);
                                            echo $five_wickets_retrieve_query_execute1['Firstname'] . " " . $five_wickets_retrieve_query_execute1['Lastname'] . "</td><td>" . $five_wickets_query_execute1['Five_wickets'];
                                        }
                                    } else {
                                        echo "</td><td>";
                                    } ?> </td>
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                    $overs_query = "SELECT * FROM t20bowling_statistics ORDER BY Overs DESC LIMIT 1";
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                    $runs_query = "SELECT * FROM t20bowling_statistics ORDER BY Runs DESC LIMIT 1";
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="background-color:#800000;text-color:white;">
                                <?php
                                $caught_query = "SELECT * FROM t20batting_statistics ORDER BY Caught DESC LIMIT 5";
                                $is_caught_query_run = mysqli_query($connect, $caught_query);
                                ?>
                                </td>
                                <td> <?php ?> </td>
                ...
                <div class="modal" id="bowledModal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="background-color:#800000;text-color:white;">
                                <?php
                                $bowled_query = "SELECT * FROM t20batting_statistics ORDER BY Bowled DESC LIMIT 5";
                                $is_bowled_query_run = mysqli_query($connect, $bowled_query);
                                ?>
                                </td>
                                <td> <?php ?> </td>
                ...
                <div class="modal" id="lbwModal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="background-color:#800000;text-color:white;">
                                <?php
                                $lbw_query = "SELECT * FROM t20batting_statistics ORDER BY LBW DESC LIMIT 5";
                                $is_lbw_query_run = mysqli_query($connect, $lbw_query);
                                ?>
                                </td>
                                <td> <?php ?> </td>
                ...
                <div class="modal" id="runoutModal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="background-color:#800000;text-color:white;">
                                <?php
                                $runout_query = "SELECT * FROM t20batting_statistics ORDER BY Runout DESC LIMIT 5";
                                $is_runout_query_run = mysqli_query($connect, $runout_query);
                                ?>
                                </td>
                                <td> <?php ?> </td>
                ...
                <div class="modal" id="stumpedModal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="background-color:#800000;text-color:white;">
                                <?php
                                $stumped_query = "SELECT * FROM t20batting_statistics ORDER BY Stumped DESC LIMIT 5";
                                $is_stumped_query_run = mysqli_query($connect, $stumped_query);
                                ?>
                                </td>
                                <td> <?php ?> </td>
                ...
                <div class="modal" id="hitwicketModal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="background-color:#800000;text-color:white;">
                                <?php
                                $hitwicket_query = "SELECT * FROM t20batting_statistics ORDER BY Hitwicket DESC LIMIT 5";
                                $is_hitwicket_query_run = mysqli_query($connect, $hitwicket_query);
                                ?>
                                </td>
                                <td> <?php ?> </td>
                ...
                <div class="modal" id="notoutModal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="background-color:#800000;text-color:white;">
                                <?php
                                $notout_query = "SELECT * FROM t20batting_statistics ORDER BY Notout DESC LIMIT 5";
                                $is_notout_query_run = mysqli_query($connect, $notout_query);
                                ?>
                                </td>
                                <td> <?php ?> </td>
    ...
    <script type="text/javascript">
        function call() {
            alert("If you want to see 50-50 Records Click \"50-50\" Blue Button");
        }
        //call();
