...
<body>
  ...
  <div class="container" id="one"><br>
    <div class="row">
      <div class="col-md-4"><label> <a href="addplayer"> Before continue please add new players</a></label></div>
    </div>
    <div class="row">
      <div class="col-md-4"></div>
      <div class="col-md-4"><button class="form-control" type="button" class="btn btn-default"
          onclick="location.href='match';">
          <font size=3 color="#800000">Continue</font>
        </button></div>
    </div>
    <br>
  </div>
