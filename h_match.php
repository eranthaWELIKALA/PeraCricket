...
<body>
    ...
    <div style="float:left; width:75%">
        <br><br><br>
        <form action="h_match" method="post">
            <h3>Match Details</h3>
            <table>
                <tbody>
                    <tr>
            ...
            <option class='form-control' value='ht'>Hit Wicket</option>
                        ...
                        echo "' /></td></tr>";
                        if (isset($_POST["marks" . $itr . 'a']) && is_numeric($_POST["marks" . $itr . 'a'])) {
                            $totalA = $totalA + $_POST["marks" . $itr . 'a'];
                        }
                    ...
                    <tr>
                        <td>Extras</td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='number' min='0' name='extrasA' value='";
                    ...
                    <tr>
                        ...
                        <td><input class='form-control' type='number' min='0' name='total'
                                value='<?php echo $totalA; ?>' /></td>
                        <td>for <?php echo $wicketsA; ?> wickets</td>
                    </tr>
                    <tr>
                        <td></td>
            ...
            <table>
                ...
                <option class='form-control' value='b'>Bowled</option>
                        ...
                        if (isset($_POST['bovers' . $itr2 . 'a'])) {
                            echo $_POST['bovers' . $itr2 . 'a'];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='number' min='0' name='bruns" . $itr2 . "a' value='";
                        if (isset($_POST['bruns' . $itr2 . 'a']) && is_numeric($_POST['bruns' . $itr2 . 'a'])) {
                            echo $_POST['bruns' . $itr2 . 'a'];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='number' min='0' name='bextras" . $itr2 . "a' value='";
                        if (isset($_POST['bextras' . $itr2 . 'a']) && is_numeric($_POST['bextras' . $itr2 . 'a'])) {
                            echo $_POST['bextras' . $itr2 . 'a'];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='number' min='0' name='bwickets" . $itr2 . "a' value='";
                        if (isset($_POST['bwickets' . $itr2 . 'a']) && is_numeric($_POST['bwickets' . $itr2 . 'a'])) {
                            echo $_POST['bwickets' . $itr2 . 'a'];
                        }
                        echo "'/></td>";

                        echo "<td><input class='form-control' type='text' name='becon" . $itr2 . "a' value='";
                        if (isset($_POST['becon' . $itr2 . 'a'])) {
                            echo $_POST['becon' . $itr2 . 'a'];
                        }
                        echo "'/></td></tr>";
                    ...
                    <tr>
                        <td></td>
                        <td></td>
                        <td><?php echo "<input class='form-control' type='text' name='opoversA' required value='";
...
if (isset($_POST['opoversA'])) {
    $_SESSION['opoversA'] = $_POST['opoversA'];
} else {
    $_SESSION['opoversA'] = NULL;
}
if (isset($_POST['extrasA'])) {
    $_SESSION['extrasA'] = $_POST['extrasA'];
} else {
...
for ($itr2 = 1; $itr2 < $batsmenA; $itr2++) {
    ...
    if (isset($_POST['howout' . $itr2 . 'a'])) {
        $_SESSION['howout' . $itr2 . 'a'] = $_POST['howout' . $itr2 . 'a'];
    }
    if (isset($_POST['marks' . $itr2 . 'a'])) {
        $_SESSION['marks' . $itr2 . 'a'] = $_POST['marks' . $itr2 . 'a'];
    }
}
for ($itr3 = 1; $itr3 < $bowlersA; $itr3++) {
    ...
    if (isset($_POST['bruns' . $itr3 . 'a'])) {
        $_SESSION['bruns' . $itr3 . 'a'] = $_POST['bruns' . $itr3 . 'a'];
    }
    if (isset($_POST['bovers' . $itr3 . 'a'])) {
        $_SESSION['bovers' . $itr3 . 'a'] = $_POST['bovers' . $itr3 . 'a'];
    }
    if (isset($_POST['bextras' . $itr3 . 'a'])) {
        $_SESSION['bextras' . $itr3 . 'a'] = $_POST['bextras' . $itr3 . 'a'];
    }
    if (isset($_POST['bwickets' . $itr3 . 'a'])) {
        $_SESSION['bwickets' . $itr3 . 'a'] = $_POST['bwickets' . $itr3 . 'a'];
    }
}
