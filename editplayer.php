...
<body>
    ...
    <br><br>
    <div class='container' align='center'>
        <form enctype="multipart/form-data" action="editplayer" method="post">
            <table>
                <tr>
                    <td>Reg No.</td>
                    <td><?php
                    ...
                    echo "</datalist>";
                    ?></td>
                    <td><input class='form-control typr=' text' name='change'
                            value='<?php echo $player_query_execute['Reg_no']; ?>' placeholder='changed reg no.' /></td>
                    </td>
                </tr>
                <tr>
                    <td>Image</td>
                ...
                <tr>
                    <td>Firstname</td>
                    <td><input class='form-control' type='text' name='firstname' placeholder='Changed Firstname'></td>
                </tr>
                <tr>
                    <td>Firstname</td>
                    <td><input class='form-control' type='text' name='lastname' placeholder='Changed Lastname'></td>
                </tr>
                <tr>
                    <td>Batting Hand</td>
                    <td>
